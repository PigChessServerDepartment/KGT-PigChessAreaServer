...
export class RandomMatchSystem {
    private queue_3v3_by_player: QueueNodeMsg[] = [];//value=1
    private queue_1v1_by_player: QueueNodeMsg[] = [];//value=3
    //1v3队列
    private queue_1v3_value3_by_player: QueueNodeMsg[] = [];//value=1
    private queue_1v3_value1_by_player: QueueNodeMsg[] = [];//value=3
    ...
    get_random_match_system_status()
    {
        ...
        if(this.queue_1v1_by_player.length>=1)
        {
            status.push(MatchType.oneVone)
        }
        if(this.queue_3v3_by_player.length>=1)
        {
            status.push(MatchType.moreVmore)
        }
        if(this.queue_1v3_value1_by_player.length>=1||this.queue_1v3_value3_by_player.length>=1)
        {
    ...
    add_to_queue(match_type:MatchType,playermessage: QueueNodeMsg) 
    {
        switch(match_type)
        {
            case MatchType.oneVone:
                this.insert_to_queue_1v1(playermessage); 
                break;
            case MatchType.moreVmore:
                this.insert_to_queue_3v3(playermessage);
                break;
            case MatchType.oneVmore_value1:
                this.insert_to_queue_1v3_value1(playermessage);
                break;
            case MatchType.oneVmore_value3:
                this.insert_to_queue_1v3_value3(playermessage);
                break;
        }
    }

    insert_to_queue_3v3(playermessage: QueueNodeMsg) {
        this.queue_3v3_by_player.push(playermessage);
    }

    insert_to_queue_1v1(playermessage: QueueNodeMsg) {    
        this.queue_1v1_by_player.push(playermessage);
    }

    insert_to_queue_1v3_value3(playermessage: QueueNodeMsg) {
        this.queue_1v3_value3_by_player.push(playermessage);
    }

    insert_to_queue_1v3_value1(playermessage: QueueNodeMsg) {
        this.queue_1v3_value1_by_player.push(playermessage);
    }

    get_queue_a_3v3() {
        return this.queue_3v3_by_player.shift();
    }

    get_queue_a_1v1() {
        return this.queue_1v1_by_player.shift();
    }

    get_queue_a_1v3_value3() {
        return this.queue_1v3_value3_by_player.shift();
    }

    get_queue_a_1v3_value1() {
        return this.queue_1v3_value1_by_player.shift();
    }
}
